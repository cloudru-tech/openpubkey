...
// CloudruOptions is an options struct that configures how providers.CloudruOp
// operates. See providers.GetDefaultCloudruOpOptions for the recommended default
// values to use when interacting with Cloudru as the OpenIdProvider.
type CloudruOptions struct {
...
func GetDefaultCloudruOpOptions() *CloudruOptions {
	return &CloudruOptions{
		Issuer:   "https://id.cloud.ru/auth/system",
		ClientID: "openpubkey",
...
// NewCloudruOp creates a Azure OP (OpenID Provider) using the
// default configurations options. It uses the OIDC Relying Party (Client)
// setup by the OpenPubkey project.
func NewCloudruOp() BrowserOpenIdProvider {
	options := GetDefaultCloudruOpOptions()
	return NewCloudruOpWithOptions(options)
}

// NewCloudruOpWithOptions creates a Cloudru OP with configuration specified
// using an options struct. This is useful if you want to use your own OIDC
// Client or override the configuration.
func NewCloudruOpWithOptions(opts *CloudruOptions) BrowserOpenIdProvider {
	return &StandardOp{
...
type CloudruOp = StandardOp

var _ OpenIdProvider = (*CloudruOp)(nil)
var _ BrowserOpenIdProvider = (*CloudruOp)(nil)
var _ RefreshableOpenIdProvider = (*CloudruOp)(nil)
